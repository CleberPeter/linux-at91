...
static struct atmel_classd_pdata *atmel_classd_dt_init(struct device *dev)
{
	...
	if (ret) pdata->non_overlap_enable = false;
	else pdata->non_overlap_enable = true;
	...
	int mute)
{
	...
	// printk("\n atmel_classd_codec_dai_digital_mute - mute:%d",mute);
					...
					int cmd, struct snd_soc_dai *codec_dai)
{
	...
	case SNDRV_PCM_TRIGGER_PAUSE_RELEASE:
		...
		// printk("\n cmd - SNDRV_PCM_TRIGGER_START/SNDRV_PCM_TRIGGER_RESUME/SNDRV_PCM_TRIGGER_PAUSE_RELEASE");
	...
	case SNDRV_PCM_TRIGGER_PAUSE_PUSH:
		...
		// printk("\n cmd - SNDRV_PCM_TRIGGER_STOP/SNDRV_PCM_TRIGGER_SUSPEND/SNDRV_PCM_TRIGGER_PAUSE_PUSH");
